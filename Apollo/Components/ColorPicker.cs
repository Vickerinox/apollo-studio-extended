...
namespace Apollo.Components {
    public class ColorPicker: UserControl {
        ...
        void UpdateColor() {
            ...
            UpdateText();
            Hex.Foreground = (IBrush)Application.Current.FindResource("ThemeForegroundBrush");
        }
        ...
        Action HexAction(string text) {
            Action update = () => Hex.Foreground = (IBrush)Application.Current.FindResource("ThemeForegroundBrush");
            ...
            if (text.Length < 6) return () => Hex.Foreground = (IBrush)Application.Current.FindResource("ErrorBrush");

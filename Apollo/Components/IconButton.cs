    ...
    public abstract class IconButton: UserControl {
        ...
        protected bool Enabled {
            ...
            set {
                ...
                Fill = (IBrush)Application.Current.FindResource(Enabled
                    ? (mouseOver
        ...
        protected void MouseEnter(object sender, PointerEventArgs e) {
            if (Enabled) Fill = (IBrush)Application.Current.FindResource(mouseHeld? "ThemeButtonDownBrush" : "ThemeButtonOverBrush");
            mouseOver = true;
        }

        protected void MouseLeave(object sender, PointerEventArgs e) {
            if (Enabled) Fill = (IBrush)Application.Current.FindResource("ThemeButtonEnabledBrush");
        ...
        protected void MouseDown(object sender, PointerPressedEventArgs e) {
            ...
            if (MouseButton == PointerUpdateKind.LeftButtonPressed || (AllowRightClick && MouseButton == PointerUpdateKind.RightButtonPressed)) {
                ...
                if (Enabled) Fill = (IBrush)Application.Current.FindResource("ThemeButtonDownBrush");
            }
        }

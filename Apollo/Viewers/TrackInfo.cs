...
namespace Apollo.Viewers {
    public class TrackInfo: UserControl, ISelectViewer, IDraggable, IRenamable {
        ...
        public virtual void SetEnabled() => NameText.Foreground = PortSelector.Foreground = (IBrush)Application.Current.FindResource(_track.Enabled? "ThemeForegroundBrush" : "ThemeForegroundLowBrush");
